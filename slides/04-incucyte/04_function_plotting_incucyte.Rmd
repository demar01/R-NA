...
We can calculate when the difference in the plus data start to be different.
```{r}
plus_raw %>% 
 pivot_longer(everything(),names_to="exp", values_to="values") %>% 
 mutate(exp = case_when( str_detect(exp,"RNAiMAX") ~ "RNAiMAX",
...
As early as 50 h the differences start to be different. We can add this to the data, annotating the plot. 
